        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">考试批改</li>
            </ol>
          </div>
        </div>
      </div>
                ...
                <table id="dataTable" class="table table-bordered table-hover">
                  ...
                  <c:forEach items="${result.resultList}" var="result" varStatus="status">
                    <tr style="text-align: center">
                      ...
                      <td class="text-center">${result.exam.paper.PName }</td>
                      <td class="text-center">${result.student.stu_name }</td>
                      <td class="text-center">
                        <button type="button" class="btn bg-olive btn-xs"
                                onclick="location.href='${pageContext.request.contextPath}/Grade/CheckDetail.jsp?rID=${result.RID}'">批改
                        </button>
                      </td>
                    </tr>
                  </c:forEach>
